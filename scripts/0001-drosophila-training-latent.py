...
def parse_args():
    ...
    parser.add_argument('--autoencoder-path',
                        type=str,
                        default=('/home/ubuntu/repos/DiffSci2/notebooks/exploratory/dfn/'
                                 '0001-autoencoder/checkpoints/last.ckpt'),
...
def load_autoencoder(path):
    ...
    vaemodule = diffsci2.models.VAEModule.load_from_checkpoint(
        path, config=vaemoduleconfig, encdec=vaenet_model
    )
    return vaemodule
