...
def main(checkpoint_path,
    ...
    output_dir = os.path.join(checkpoint_dir, f"stats/fid_results_{n_samples}_samples_seed_{seed}_{model_name}")
...
if __name__ == "__main__":
    main(checkpoint_path="/home/ubuntu/repos/DiffSci/savedmodels/experimental/20260318-bps-mnist-128ch/checkpoints/model-epoch=039-val_loss=0.042329.ckpt",
         model_channels=128,
         n_samples=10000,
         nsteps=500,
         device_id=7,
         batch_size=500,
         gamma_list=[0.001, 0.01, 0.1, 0.5, 1.0, 2.0, 5.0, 10.0],
         seed=45,
         max_scale=160,
         model_name='nsteps=500-max_scale=160-epoch=39')
