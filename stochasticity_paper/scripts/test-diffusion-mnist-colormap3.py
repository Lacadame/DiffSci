...
if __name__ == "__main__":
    main(checkpoint_path="/home/ubuntu/repos/DiffSci/savedmodels/production/20260318-bps-mnist-128ch/checkpoints/model-epoch=009-val_loss=0.045098.ckpt",
         model_channels=128,
         n_samples=10000,
         nsteps=500,
         device_id=4,
         ...
         alpha=0.1,
         save_samples=False,
         model_name='nsteps=500-epoch=9-manual_grid',
